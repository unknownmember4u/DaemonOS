...
- Registered core modules: `daemon-cli`, `daemon-core`, `daemon-config`, `daemon-ipc`, `daemon-wm`, `daemon-panel`, `daemon-launcher`, `daemon-settings`, `daemon-notify`, `daemon-lock`, `daemon-installer`.
